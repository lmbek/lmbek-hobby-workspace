...
// Run switches all cloned repositories to the branch defined in system-definition.yaml.
// If a branch argument is provided via BRANCH env var, it overrides the definition.
func Run() error {
